document.addEventListener("DOMContentLoaded", () => {
  ...
  submitButton.addEventListener("click", (event) => {
    ...
    async function fetchFoodAPI() {
      ...
      const options = {
        ...
        headers: {
          "x-rapidapi-key":
            "5f36438cdfmsh35b8aa8adc1d663p1d319cjsn3b4817b74143",
          "x-rapidapi-host":
      ...
      try {
        ...
        console.log(result);
        myActivity.innerHTML = JSON.stringify(result, null, 2); // Display result in pre tag
      } catch (error) {
  ...
  // Load the recipe when the page is loaded
  // fetchFoodAPI();
});
